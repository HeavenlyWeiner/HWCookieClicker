...
public class ShopInventoryListener extends CustomInventoryListener {

    public ShopInventoryListener(CookieClicker plugin, CustomInventoryType customInventoryType) {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (type == getItemType(CustomItemType.NEXT_PAGE) && slot == getItemSlot(CustomItemType.NEXT_PAGE) && displayName.equalsIgnoreCase(languageConfig.getTranslatedLanguage(PluginLanguage.NEXT))) {
        ...
        } else if (type == getItemType(CustomItemType.PREMIUM_PAGE) && slot == getItemSlot(CustomItemType.PREMIUM_PAGE) && displayName.equalsIgnoreCase(languageConfig.getTranslatedLanguage(PluginLanguage.PREMIUM_PAGE))) {
            if (!(plugin.getPermissionsConfig().hasPermission(player, PluginPermission.PREMIUM_PERMISSION))) {
            ...
            customInventories.get(CustomInventoryType.PREMIUM_SHOP).openInventory(player);
