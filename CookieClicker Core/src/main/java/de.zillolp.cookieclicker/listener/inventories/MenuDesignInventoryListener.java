...
public class MenuDesignInventoryListener extends CustomInventoryListener {
    public MenuDesignInventoryListener(CookieClicker plugin, CustomInventoryType customInventoryType) {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        plugin.getServer().getScheduler().runTaskAsynchronously(plugin, () -> {
            ...
            if (displayName.equalsIgnoreCase(languageConfig.getPriceLanguage(PluginLanguage.PRICE_BUYABLE, shopType, id, price))) {
                ...
                clickerStatsProfile.setMenuDesign(id);
