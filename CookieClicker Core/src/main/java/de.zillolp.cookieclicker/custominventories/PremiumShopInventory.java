...
public class PremiumShopInventory extends CustomScrollingInventory {
    ...
    public PremiumShopInventory(CookieClicker plugin, Player player, String title, int size, Integer[] skippedSlots, int startSlot, int stopSlot, CustomInventoryType customInventoryType) {
